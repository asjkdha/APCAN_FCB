...
parser.add_argument('--ntrain', type=int, default=800, help='number of samples to train on')
...
# test options
parser.add_argument('--ntest', type=int, default=500, help='number of images to test per epoch or test run')
